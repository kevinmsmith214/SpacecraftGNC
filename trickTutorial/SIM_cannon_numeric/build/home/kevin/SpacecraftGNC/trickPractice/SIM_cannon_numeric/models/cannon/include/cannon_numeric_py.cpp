...
/*-----------------------------------------------
              @(target):= _m5f04aca396244b53f12d99f6db5863bf.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__m5f04aca396244b53f12d99f6db5863bf

#else
#  define SWIG_init    init_m5f04aca396244b53f12d99f6db5863bf

#endif
#define SWIG_name    "_m5f04aca396244b53f12d99f6db5863bf"
...
SWIGINTERN PyObject *_wrap_cannon_impact(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  CANNON *arg1 = (CANNON *) 0 ;
  PyObject *swig_obj[1] ;
  double result;
  ...
  result = (double)cannon_impact(arg1);
  {
    // DOUBLE OUT
    std::string temp_name ;
    swig_double * t = new swig_double ;
    t->value = (double)result ;
    temp_name = "cannon_impact" ;
    temp_name.erase(temp_name.length() - 4) ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "cannon_integ", _wrap_cannon_integ, METH_O, NULL},
	 { "cannon_deriv", _wrap_cannon_deriv, METH_O, NULL},
	 { "cannon_impact", _wrap_cannon_impact, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
