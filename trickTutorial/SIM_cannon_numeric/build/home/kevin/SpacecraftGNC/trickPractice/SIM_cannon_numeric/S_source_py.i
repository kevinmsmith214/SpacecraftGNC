%module mcabe675e74515b731adc79feb48b2ea2
...
%{
#include "/home/kevin/SpacecraftGNC/trickPractice/SIM_cannon_numeric/S_source.hh"
%}
...
%import "build/home/kevin/SpacecraftGNC/trickPractice/SIM_cannon_numeric/models/cannon/include/cannon_numeric_py.i"
%import "build/home/kevin/SpacecraftGNC/trickPractice/SIM_cannon_numeric/models/cannon/include/optimization_py.i"
...
%}
    ...
    public:
        ...
        CannonSimObject() {
            ...
            job = this->add_job(0, 4, "monte_slave_post", NULL, 1, "cannon_slave_post", "", 60000) ;
            job = this->add_job(0, 5, "monte_master_post", NULL, 1, "cannon_master_post", "", 60000) ;
            job = this->add_job(0, 6, "dynamic_event", NULL, 1, "cannon_impact", "", 60000) ;
        }
