...
/*-----------------------------------------------
              @(target):= _m289334139c407ab89a68dc14b889cdb4.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__m289334139c407ab89a68dc14b889cdb4

#else
#  define SWIG_init    init_m289334139c407ab89a68dc14b889cdb4

#endif
#define SWIG_name    "_m289334139c407ab89a68dc14b889cdb4"
...
SWIGINTERN PyObject *_wrap_cannon_slave_post(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  result = (int)cannon_slave_post(arg1);
  {
    // INT OUT
    std::string temp_name ;
    swig_int * t = new swig_int ;
    t->value = (long long)result ;
    temp_name = "cannon_slave_post" ;
...
SWIGINTERN PyObject *_wrap_cannon_master_post(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  CANNON *arg1 = (CANNON *) 0 ;
  PyObject *swig_obj[1] ;
  int result;
  ...
  result = (int)cannon_master_post(arg1);
  {
    // INT OUT
    std::string temp_name ;
    swig_int * t = new swig_int ;
    t->value = (long long)result ;
    temp_name = "cannon_master_post" ;
    temp_name.erase(temp_name.length() - 4) ;
    //cout << "swig_int out looking for param " << temp_name << std::endl ;
    t->units = Trick::UnitsMap::units_map()->get_units(temp_name) ;
    //cout << "swig_int out found units " << t->units << std::endl ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "cannon_slave_post", _wrap_cannon_slave_post, METH_O, NULL},
	 { "cannon_master_post", _wrap_cannon_master_post, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
