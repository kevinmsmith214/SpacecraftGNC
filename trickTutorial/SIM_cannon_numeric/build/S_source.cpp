...
/* Created 2025/04/04 14:25:03 kevin $ */
#include "../S_source.hh"
...
int CannonSimObject::call_function ( Trick::JobData * curr_job ) {
    ...
    switch ( curr_job->id ) {
        ...
        case 3:
            ...
            break ;
        case 4:
            cannon_slave_post( &cannon ) ;
            break ;
        case 5:
            cannon_master_post( &cannon ) ;
            break ;
        default:
            trick_ret = -1 ;
            break ;
...
double CannonSimObject::call_function_double ( Trick::JobData * curr_job ) {
    ...
    switch ( curr_job->id ) {
        case 6:
            trick_ret = cannon_impact( &cannon ) ;
            break ;
        default:
            trick_ret = 0.0 ;
            break ;
...
SimEnvironment::SimEnvironment() {
    ...
    local_env["TRICK_HOME"] = "/home/kevin/trick";
    ...
    local_env["TRICK_PATH"] = "/home/kevin/trick/libexec/bin";
    ...
    local_env["TRICK_SYSTEM_CFLAGS"] = "-isystem/home/kevin/trick/trick_source -isystem/home/kevin/trick/include -isystem/home/kevin/trick/include/trick/compat -DTRICK_VER=19 -DTRICK_MINOR=8 -fpic  -DUSE_ER7_UTILS_INTEGRATORS -fexceptions";
    setenv("TRICK_SYSTEM_CFLAGS", local_env["TRICK_SYSTEM_CFLAGS"].c_str(), 0);
    local_env["TRICK_SYSTEM_CXXFLAGS"] = "-isystem/home/kevin/trick/trick_source -isystem/home/kevin/trick/include -isystem/home/kevin/trick/include/trick/compat -DTRICK_VER=19 -DTRICK_MINOR=8 -fpic  -DUSE_ER7_UTILS_INTEGRATORS";
    ...
    local_env["TRICK_USER_CSHRC"] = "/home/kevin/.Trick_user_cshrc";
    setenv("TRICK_USER_CSHRC", local_env["TRICK_USER_CSHRC"].c_str(), 0);
    local_env["TRICK_USER_HOME"] = "/home/kevin/trick_sims";
    ...
    local_env["TRICK_USER_PROFILE"] = "/home/kevin/.Trick_user_profile";
    ...
    local_env["XML_CATALOG_FILES"] = "/home/kevin/trick/libexec/trick_source/data_products/DPX/XML/catalog.xml";
...
void memory_init( void ) {
    ...
    ALLOC_INFO * ai ;
    exec_set_version_date_tag( "@(#)CP Version 19.8.0-beta, Fri Apr  4 14:25:03 2025" ) ;
    exec_set_build_date( "Fri Apr  4 14:25:03 2025" ) ;
